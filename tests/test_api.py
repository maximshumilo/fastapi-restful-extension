...
def test__get_item__success(rest_api_instance, api_version_instance):
    ...
    rest_api_instance.rest_api_routers[prefix] = api_version_instance
...
def test__apply__success(rest_api_instance, resource_type, api_version_instance):
    ...
    rest_api_instance.include_rest_api_router(api_version_instance)
...
def test__include_api_version__failed__prefix_is_exist(rest_api_instance, api_version_instance):
    ...
    rest_api_instance.rest_api_routers[api_version_instance.router.prefix] = api_version_instance
    exc = pytest.raises(AssertionError, rest_api_instance.include_rest_api_router, api_version_instance)
